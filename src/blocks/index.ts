...
export const BLOCKS: Block[] = [risks, water, air, noise, climate, internet, mobile, housing, energy, tax, urbanism, sun, schools, health, shops, chargers];
...
export const GROUPS: { title: string; ids: string[] }[] = [
  ...
  { title: 'Logement', ids: ['housing', 'energy', 'sun', 'tax', 'urbanism'] },

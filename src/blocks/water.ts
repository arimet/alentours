...
import { PARAMS, buildView, resultsUrl, udiUrl } from '../lib/water';

export const water: Block = {
  id: 'water',
  ...
  load: async (ctx) => {
    ...
    const [udi, compliance, nitrates, pfas, pesticides] = answers;
    return buildView({ udi, compliance, nitrates, pfas, pesticides });
  },
};
